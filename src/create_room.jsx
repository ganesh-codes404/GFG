...
const GAMES_BY_PLAYERS = {
  2: ["Chess", "Connect 4", "One and Only", "Word Rush", "Tic Tac Toe", "Checkers", "Pong","Cricket","Guess Who"],
  3: ["Ludo", "One and Only", "Dots & Boxes", "Carrom", "Word Rush","Snakes and Ladders","Catan","Guess Who"],
  4: ["Codenames", "Andhra Business", "Trivia","Ludo","Word Rush","Snakes and Ladders","Catan","One and Only","Guess Who"],
  ...
  6: ["Among Us", "Hide & Seek", "Team Trivia", "Bomb Tag", "Capture the Flag","Chinese Whisper","Andhra Business","Snakes and Ladders","Word Rush","Imposter","Pictionary","Battle Royale","Secret Agent"],
